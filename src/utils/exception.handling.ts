    ...
    // Handle Prisma Known Errors
      ...
      switch (exception.code) {
        ...
        case 'P2006':
          status = 400;
          message =
            'The data provided for a field is invalid for the database type';
          break;

        case 'P2007':
          status = 400;
          message =
            'The data provided does not match the expected format or constraints in the database schema';
          break;

        case 'P2025': // Record not found
          status = 404;
          message =
            exception?.meta?.cause || 'The requested resource was not found.';
          break;
